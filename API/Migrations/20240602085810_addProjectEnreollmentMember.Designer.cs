...
namespace API.Migrations
{
    ...
    [Migration("20240602085810_addProjectEnreollmentMember")]
    partial class addProjectEnreollmentMember
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Project.ProjectEnrollmentMember", b =>
                {
                    ...
                    b.Property<int>("ProjectEnrollmentId")
                        .HasColumnType("INTEGER");

                    b.Property<Guid>("ProjectEnrollmentId1")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ProjectEnrollmentId1");
            ...
            modelBuilder.Entity("Domain.Project.ProjectEnrollmentMember", b =>
                {
                    b.HasOne("Domain.Project.ProjectEnrollment", "ProjectEnrollment")
                        .WithMany("ProjectEnreollmentMembers")
                        .HasForeignKey("ProjectEnrollmentId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Project.ProjectEnrollment", b =>
                {
                    b.Navigation("ProjectEnreollmentMembers");
                });
