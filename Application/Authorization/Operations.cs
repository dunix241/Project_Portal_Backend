...
namespace Application.Authorization
{
    ...
    public class Constants
    {
        ...
        public static readonly string SuperAdminsRole = "SuperAdmins";
        public static readonly string AdminsRole = "Admins";
        public static readonly string LecturersRole = "Lecturers";
        public static readonly string StudentsRole = "Students";
    }
}
